...
".picker-dialog { background: #ffffff; border-radius: 16px; padding: 20px; width: 320px; box-shadow: 0 10px 30px rgba(0,0,0,0.4); text-align: center; animation: popIn 0.25s ease-out; }"
"@keyframes popIn { from { opacity: 0; transform: scale(0.9); } to { opacity: 1; transform: scale(1); } }"
".picker-title { font-weight: bold; margin-bottom: 16px; color: #333; font-size: 1.2em; }"
".picker-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; margin-bottom: 16px; }"
".picker-btn { padding: 20px; font-size: 2em; border-radius: 12px; border: 2px solid #764ba2; background: linear-gradient(135deg, #f7f5ff 0%, #e8e4ff 100%); cursor: pointer; transition: all 0.15s; font-weight: bold; color: #764ba2; }"
".picker-btn:active { transform: scale(0.95); background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; }"
".picker-cancel { padding: 12px 20px; font-size: 1em; border-radius: 8px; border: 2px solid #bbb; background: #f5f5f5; cursor: pointer; font-weight: bold; }"
"</style>"
"</head>"
"<body>"
"<div class='container'>"
