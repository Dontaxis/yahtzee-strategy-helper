...
"<input type='number' id='pickerInput' class='picker-input' inputmode='numeric' pattern='[1-6]' min='1' max='6' />"
...
"updateDisplay();}"
"function openPicker(index){currentPickerIndex=index;pickerInput.value='';pickerOverlay.style.display='flex';setTimeout(function(){pickerInput.focus();pickerInput.select();},100);}"
