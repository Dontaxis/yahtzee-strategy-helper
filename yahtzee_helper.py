...
"updateDisplay();}"
"function openPicker(index){currentPickerIndex=index;pickerInput.value='';pickerOverlay.style.display='flex';pickerInput.focus();setTimeout(function(){pickerInput.focus();},10);setTimeout(function(){pickerInput.focus();},50);}"
...
"function autoAdvanceToNextDie(currentIndex){for(var i=currentIndex+1;i<5;i++){if(gameState.dice[i]===0){setTimeout(function(idx){return function(){openPicker(idx);};}(i),150);return;}}}"
